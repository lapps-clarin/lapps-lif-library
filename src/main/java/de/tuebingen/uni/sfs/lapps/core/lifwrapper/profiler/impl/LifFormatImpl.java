...
import de.tuebingen.uni.sfs.lapps.core.lifwrapper.profiler.impl.ValidityCheckerImpl;
...
import de.tuebingen.uni.sfs.lapps.core.lifwrapper.anno.impl.LifConstituentParserStored;
import de.tuebingen.uni.sfs.lapps.core.lifwrapper.anno.impl.LifDependencyParserStored;
import de.tuebingen.uni.sfs.lapps.core.lifwrapper.anno.impl.LifNameEntityLayerStored;
import de.tuebingen.uni.sfs.lapps.core.lifwrapper.anno.impl.LifRefererenceLayerStored;
import de.tuebingen.uni.sfs.lapps.core.lifwrapper.anno.impl.LifSentenceLayerStored;
import de.tuebingen.uni.sfs.lapps.core.lifwrapper.anno.impl.LifTokenLayerStored;
...
public class LifFormatImpl implements LifFormat {
    ...
    public boolean isValid() throws JsonParseException, IOException, JsonValidityException, LifException {
        LifContainer lifContainer = null;
        ValidityCheckerImpl lifValidityCheck = new ValidityCheckerImpl(fileString);
        if (lifValidityCheck.isValid()) {
            lifContainer = new ObjectMapper().readValue(fileString, LifContainer.class);
